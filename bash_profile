recon(){
  ...
  python3 $HOME/Desktop/tools/Sublist3r/sublist3r.py -d $1 -o $HOME/Recon/$1/domains.txt
  ...
  #python3 ~/Desktop/tools/dirsearch/dirsearch.py -L $HOME/Recon/$1/live.txt -e * --plain-text-report=$HOME/Recon/$1/dirsearch.txt
}
